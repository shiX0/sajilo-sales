...
import 'package:sajilo_sales/features/auth/data/data_source/local/auth_local_data_source.dart';
...
class AuthLocalRepository implements IAuthRepository {
  ...
  @override
  Future<Either<Failure, bool>> loginAccount(String username, String password) {
    return _authLocalDataSource.loginStudent(username, password);
  }

  @override
  Future<Either<Failure, bool>> registerAccount(AuthEntity student) {
